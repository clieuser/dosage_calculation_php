...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" style="width:90px;">방식</th>
			<th scope="col" style="width:80px;">배수</th>
			<th scope="col" style="width:80px;">Min</th>
			<th scope="col" style="width:80px;">Max</th>
        ...
        <tr>
			...
			<td>
				<select name="wr_4[<?php echo $i;?>]">
				<option value="0">곱하기</option>
				<option value="1" <?php echo (($list[$i]['wr_4']==1)?"selected":"");?>>나누기</option>
				</select>
			</td>
			...
			<td>
				<input type="text" name="wr_5[<?php echo $i;?>]"  value="<?php echo $list[$i]['wr_5'];?>">
			</td>

			<td>
				<input type="text" name="wr_6[<?php echo $i;?>]"  value="<?php echo $list[$i]['wr_6'];?>">
			</td>
