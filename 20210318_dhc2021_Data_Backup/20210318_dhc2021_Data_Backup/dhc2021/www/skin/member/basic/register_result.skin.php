...
<!-- 회원가입결과 시작 { -->
<div id="reg_result" class="register" style="text-align:center;">
...
<div class="btn_confirm_reg">
	<a href="<?php echo G5_URL ?>/" class="reg_btn_submit" style='color:white;font-size:15px;font-weight:normal;'>메인으로</a>
</div>