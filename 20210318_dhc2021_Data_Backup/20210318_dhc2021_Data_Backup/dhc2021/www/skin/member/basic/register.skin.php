...
<div class="register">
    ...
    <section id="fregister_private">
        <h2>개인정보처리방침안내</h2>
        <ul class="rcard">
			<li>목적 : 이용자 식별 및 본인여부 확인</li>
			<li>항목 : 아이디, 이름, 비밀번호</li>
			<li>보유기간: 회원 탈퇴 시까지</li>
		</ul>
		
		<ul class="rcard rcard_grey">
			<li>목적 : 고객서비스 이용에 관한 통지, CS대응을 위한 이용자 식별</li>
			<li>항목 : 연락처 (이메일, 휴대전화번호)</li>
			<li>보유기간 : 회원 탈퇴 시까지</li>
		</ul>
