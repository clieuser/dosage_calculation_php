...
include_once G5_PATH."/plugin/Mobile-Detect/Mobile_Detect.php";
...
if (G5_IS_MOBILE) {
	...
	$member_skin_path = G5_PATH."/skin/member/".$config['cf_mobile_member_skin'];
    $member_skin_url = G5_URL."/skin/member/".$config['cf_mobile_member_skin'];
    $search_skin_path = G5_PATH."/skin/search/".$config['cf_mobile_search_skin'];
    $search_skin_url = G5_URL."/skin/search/".$config['cf_mobile_search_skin'];
	/*
