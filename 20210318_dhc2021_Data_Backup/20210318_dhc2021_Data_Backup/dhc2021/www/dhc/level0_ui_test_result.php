...
<div id="examCon">
	...
	<tr class="exam0 examTr examFalse">
		<td class="num">1</td>
...
<tr class="exam0 examTr examTrue">
	...
	<ul>
		<li>
			<button type="button" class="btn btn-lg btn-success">트레이닝 연습하기</button>
		</li>
	<li>
			<button type="button" class="btn btn-lg btn-primary" onclick="location.href='./level0_ui_test_complete.php'">테스트 계속하기</button>
		</li>
	</ul>
</div>
